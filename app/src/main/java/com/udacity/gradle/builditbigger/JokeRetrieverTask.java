...
import mobi.farshad.backend.joker.myApi.MyApi;
...
public class JokeRetrieverTask extends AsyncTask<Void, Void, String> {
    ...
    public interface JokeCallback {
        void getJokeCallback(String joke);
    }

    private static MyApi myApiService = null;
    private JokeCallback jokeCallback;

    public JokeRetrieverTask(JokeCallback callback) {
    ...
    protected void onPostExecute(String result) {
        jokeCallback.getJokeCallback(result);
    }
}
